package com.fristspringboot.example.frist_spring_app;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import com.fristspringboot.example.frist_spring_app.model.Address;
import com.fristspringboot.example.frist_spring_app.model.Employee;
import org.springframework.boot.SpringApplication;
...
//@ComponentScan
public class FristSpringAppApplication {

	public static void main(String[] args) {

		SpringApplication.run(FristSpringAppApplication.class, args);
